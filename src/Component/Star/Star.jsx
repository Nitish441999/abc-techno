...
function Star() {
  ...
  return (
    <div>
        <section className="p-6 mt-10  dark:text-gray-800">
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gradient-to-r to-orange-400 from-blue-700 dark:text-gray-800"  data-aos="zoom-in" data-aos-duration="1200">
                    <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-white text-black">
